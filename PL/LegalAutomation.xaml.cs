    ...
    public partial class LegalAutomation : Window
    {
        ...
        private void LoadTemplates()
        {
            templates = new List<BriefTemplate>
            {
                ...
                new BriefTemplate { Id = 12, Title = "معرفی داور", Content = "لطفاً متن لایحه موردنظر خود را در این قسمت وارد نمایید..." },
                new BriefTemplate { Id = 13, Title = "عدم حضور", Content = "لطفاً متن لایحه موردنظر خود را در این قسمت وارد نمایید..." },
                new BriefTemplate { Id = 14, Title = "✍️ لایحه (سفارشی)", Content = "لطفاً متن لایحه موردنظر خود را در این قسمت وارد نمایید..." },               
            };
